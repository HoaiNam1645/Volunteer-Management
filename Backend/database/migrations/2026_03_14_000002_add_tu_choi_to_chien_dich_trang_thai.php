...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `chien_dichs` MODIFY COLUMN `trang_thai` ENUM('nhap','cho_duyet','tu_choi','da_duyet','dang_dien_ra','hoan_thanh','yeu_cau_huy','da_huy') NOT NULL DEFAULT 'nhap'");
    }

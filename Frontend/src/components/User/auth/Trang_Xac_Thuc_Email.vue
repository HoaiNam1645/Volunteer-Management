				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="card border-0 shadow-lg rounded-4 overflow-hidden">
						...
						<div v-else-if="success" class="card-body text-center p-5 animation-fade-in">
							...
							<router-link to="/dang-nhap" class="btn btn-primary w-100 py-3 fw-bold rounded-3">
						...
						<div v-else class="card-body text-center p-5 animation-fade-in">
							<div class="bg-danger bg-opacity-10 text-danger d-inline-flex align-items-center justify-content-center rounded-circle mb-4"
								style="width: 90px; height: 90px;">

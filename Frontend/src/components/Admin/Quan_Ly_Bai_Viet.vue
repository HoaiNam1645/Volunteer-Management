	...
	data() {
		return {
			...
			articles: [
				...
				{ id: 2, title: 'Câu chuyện TNV: Từ sinh viên nhút nhát đến điều phối viên tự tin', author: 'Phạm Đức', category: 'story', status: 'published', views: '890', likes: 167, comments: 29, date: '03/03/2026', image: 'https://images.unsplash.com/photo-1531545514256-b1400bc00f31?w=100&q=80' },
